        ...
        <main class="d-flex justify-content-between">
            <div class="left-sidebar">
                ...
                <div class="shortcuts pb-5">
                    ...
                    <a class="left-item d-flex align-items-center p-2 text-dark">
                        <img src="assets/images/shortcuts/short-1.jpg" alt="" width="35" height="35" style="border:1px solid #9e9e9e;border-radius: 10%;">
                        <p class="ps-2 fw-bold fs-6">City University Programming Club(CUPC)</p>
                    </a>
                    <a class="left-item d-flex align-items-center p-2 text-dark">
                        <img src="assets/images/shortcuts/short-2.jpg" alt="" width="35" height="35" style="border:1px solid #9e9e9e;border-radius: 10%;">
                        <p class="ps-2 fw-bold fs-6">Laravel Experts Bangladesh</p>
                    </a>
                    <a class="left-item d-flex align-items-center p-2 text-dark">
                        <img src="assets/images/shortcuts/short-3.jpg" alt="" width="35" height="35" style="border:1px solid #9e9e9e;border-radius: 10%;">
                        <p class="ps-2 fw-bold fs-6">চাকরি প্রার্থী-Job Candidates</p>
                    </a>
                    <a class="left-item d-flex align-items-center p-2 text-dark">
                        <img src="assets/images/shortcuts/short-4.jpg" alt="" width="35" height="35" style="border:1px solid #9e9e9e;border-radius: 10%;">
                        <p class="ps-2 fw-bold fs-6">City University Family</p>
                    </a>
                    <a class="left-item d-flex align-items-center p-2 text-dark">
                        <img src="assets/images/shortcuts/short-5.png" alt="" width="35" height="35" style="border:1px solid #9e9e9e;border-radius: 10%;">
                    ...
                    <div class="post-view-item">
                        <div class="post-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="post-action">
                                ...
                                <a href="#" class="ps-2" style="color: gray; font-size: 20px;"><i class="fa-solid fa-xmark"></i></a>
                            </div>
                        </div>
